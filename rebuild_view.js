...
let content = fs.readFileSync('app/dashboard/incentive/page.tsx', 'utf8');
...
// Now write it out to IncentiveView.tsx
fs.writeFileSync('components/IncentiveView.tsx', content);

// And restore the wrapper in app/dashboard/incentive/page.tsx
const mainWrapperContent = `"use client";
...
`;
fs.writeFileSync('app/dashboard/incentive/page.tsx', mainWrapperContent);

console.log("Successfully rebuilt IncentiveView and restored wrapper page.");
