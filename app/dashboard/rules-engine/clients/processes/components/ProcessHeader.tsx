      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-lg font-bold tracking-tight text-slate-900">Processes Management</h1>
            <span className="bg-blue-50 text-blue-700 text-[10px] font-mono font-bold px-2 py-0.5 border border-blue-200 rounded-none">
              {totalCount} Operational Processes
            </span>
          </div>
          <p className="text-xs text-slate-500 mt-0.5">
            Configure business processes linked to specific clients and locations with assigned process heads.
          </p>
        </div>
      </div>
