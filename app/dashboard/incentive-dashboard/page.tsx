        ...
        <div>
          <h1 className="text-2xl font-black tracking-tight text-slate-800 flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-blue-50 border border-blue-100 flex items-center justify-center">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-600"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
            </div>
            Incentive Dashboard
          </h1>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div className="bg-white border border-blue-100 rounded-2xl p-6 shadow-sm shadow-blue-100 relative overflow-hidden group">
              ...
              <p className="text-xs font-black text-blue-600/70 uppercase tracking-widest mb-2 relative z-10">Eligible Employees</p>
              <div className="flex items-baseline gap-2 relative z-10">
                <h2 className="text-3xl font-black text-blue-600">{eligibleEmployees}</h2>
                  ...
                  {topEarners.length === 0 ? (
                    ...
                    topEarners.map((emp, idx) => (
                      <tr key={emp.employee_id} className="hover:bg-slate-50/80 transition-colors group">
                        ...
                        <td className="py-4 px-6">
                          <div className="font-bold text-slate-800 text-sm group-hover:text-blue-600 transition-colors">{emp.name}</div>
